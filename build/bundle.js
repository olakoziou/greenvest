...
$(function () {
  ...
  if (windowResize < width) {
    ...
    $('.dots').children().css('display', 'none');
  }
  ...
  var hmaburger = $('.header__menu-icon');
  var closeMenu = $('.header__menu-navigation-icon');
  var menuItems = $('.header__menu-navigation ul li');
...
/***/ 0:
/*!*********************************************!*\
  !*** multi ./js/script.js ./scss/main.scss ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
